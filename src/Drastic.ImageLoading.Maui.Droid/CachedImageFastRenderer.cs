...
namespace Drastic.ImageLoading.Maui.Platform
{
    ...
    public class CachedImageFastRenderer : CachedImageView, IVisualElementRenderer
    {
            ...
            if (!_isDisposed)
            {
                ...
                if (disposing)
                {
                    ...
                    if (TypedElement != null)
                    {
                        ...
                        if (Microsoft.Maui.Controls.Compatibility.Platform.Android.Platform.GetRenderer(TypedElement) == this)
                        {
        ...
        private void SetBackgroundColor(Microsoft.Maui.Graphics.Color color)
        {
