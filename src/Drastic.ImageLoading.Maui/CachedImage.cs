...
namespace Drastic.ImageLoading.Maui
{
	...
	/// <summary>
	/// CachedImage modded by Drastic Actions
	/// </summary>
	public class CachedImage : View
	{
		...
		protected static bool IsDesignModeEnabled
		{
			get
			{
				// works only on Microsoft.Maui.Controls >= 3.0
		...
		private static void OnSourcePropertyChanged(BindableObject bindable, object oldValue, object newValue)
		{
			if (!IsRendererInitialized)
			{
				...
				throw new Exception("Please call CachedImageRenderer.Init method in a platform specific project to use Drastic.ImageLoading!");
			}
