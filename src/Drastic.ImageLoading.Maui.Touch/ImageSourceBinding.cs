...
namespace Drastic.ImageLoading.Maui.Platform
{
    ...
    {
        public ImageSourceBinding(Drastic.ImageLoading.Work.ImageSource imageSource, string path)
        {
        ...
        {
            ImageSource = Drastic.ImageLoading.Work.ImageSource.Stream;
            Stream = stream;
        }

        public Drastic.ImageLoading.Work.ImageSource ImageSource { get; private set; }
        ...
        internal static ImageSourceBinding GetImageSourceBinding(ImageSource source, CachedImage element = null)
        {
            ...
            {                
                ...
                return new ImageSourceBinding(Drastic.ImageLoading.Work.ImageSource.Url, uri);
            }
            ...
            if (fileImageSource != null)
            {
                ...
                if (fileImageSource.File.StartsWith("/", StringComparison.InvariantCultureIgnoreCase) && File.Exists(fileImageSource.File))
                    return new ImageSourceBinding(Drastic.ImageLoading.Work.ImageSource.Filepath, fileImageSource.File);

                return new ImageSourceBinding(Drastic.ImageLoading.Work.ImageSource.CompiledResource, fileImageSource.File);
            }
            ...
            if (embeddedResoureSource != null)
            {
                ...
                return new ImageSourceBinding(Drastic.ImageLoading.Work.ImageSource.EmbeddedResource, uri);
            }
            ...
            if (dataUrlSource != null)
            {
                ...
                return new ImageSourceBinding(Drastic.ImageLoading.Work.ImageSource.Url, dataUrlSource.DataUrl);
            }
