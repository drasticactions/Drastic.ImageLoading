...
namespace Drastic.ImageLoading.Work
{
    public class TaskParameter : IDisposable
    {
        ...
        /// <summary>
        /// Releases all resource used by the <see cref="T:Drastic.ImageLoading.Work.TaskParameter"/> object.
        /// </summary>
        /// <remarks>Call <see cref="Dispose"/> when you are finished using the
        /// <see cref="T:Drastic.ImageLoading.Work.TaskParameter"/>. The <see cref="Dispose"/> method leaves the
        /// <see cref="T:Drastic.ImageLoading.Work.TaskParameter"/> in an unusable state. After calling <see cref="Dispose"/>,
        /// you must release all references to the <see cref="T:Drastic.ImageLoading.Work.TaskParameter"/> so the garbage
        /// collector can reclaim the memory that the <see cref="T:Drastic.ImageLoading.Work.TaskParameter"/> was occupying.</remarks>
        public void Dispose()
        {
            if (!_disposed)
            {
