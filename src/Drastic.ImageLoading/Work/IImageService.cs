...
namespace Drastic.ImageLoading
{
    ...
    {
        /// <summary>
        /// Gets Drastic.ImageLoading configuration
        /// </summary>
        /// <value>The configuration used by Drastic.ImageLoading.</value>
        Configuration Config { get; }

        /// <summary>
        /// Initializes Drastic.ImageLoading with a default Configuration.
        /// Also forces to run disk cache cleaning routines (avoiding delay for first image loading tasks)
        /// </summary>
        void Initialize();

        /// <summary>
        /// Initializes Drastic.ImageLoading with a given Configuration. It allows to configure and override most of it.
        /// Also forces to run disk cache cleaning routines (avoiding delay for first image loading tasks)
        /// </summary>
